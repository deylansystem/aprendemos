const letters = {
    ...
    d: [
        ...
        { word: "Delfín", image: "delfin.png", syllables: ["empieza por", "d"] },
    ...
    h: [
        { word: "Halcón", image: "halcon.png", syllables: ["empieza por", "h"] },
        { word: "Hipopótamo", image: "hipopotamo.png", syllables: ["empieza por", "h"] },
    ...
    j: [
        ...
        { word: "Jabalí", image: "jabali.png", syllables: ["empieza por", "j"] },
        { word: "Jabón", image: "jabon.png", syllables: ["empieza por", "j"] },
    ...
    l: [
        ...
        { word: "León", image: "leon.png", syllables: ["empieza por", "l"] },
        { word: "Lápiz", image: "lapiz.png", syllables: ["empieza por", "l"] },
    ...
    m: [
        ...
        { word: "Mamá", image: "mama.png", syllables: ["empieza por", "m"] },
        { word: "Manzana", image: "manzana.png", syllables: ["empieza por", "m"] },
        { word: "Micrófono", image: "microfono.png", syllables: ["empieza por", "m"] }
    ],
    n: [
    ...
    ñ: [
        { word: "Ñandú", image: "ñandu.png", syllables: ["empieza por", "ñ"] },
        { word: "Ñoqui", image: "ñoquis.png", syllables: ["empieza por", "ñ"] },
        { word: "Ñame", image: "ñame.png", syllables: ["empieza por", "ñ"] }
    ],
    o: [
    ...
    p: [
        ...
        { word: "Pingüino", image: "pinguino.png", syllables: ["empieza por", "p"] },
        { word: "Papá", image: "papa.png", syllables: ["empieza por", "p"] },
    ...
    r: [
        ...
        { word: "Ratón", image: "raton.png", syllables: ["empieza por", "r"] },
    ...
    t: [
        ...
        { word: "Tucán", image: "tucan.png", syllables: ["empieza por", "t"] },
        { word: "Tortuga", image: "tortuga.png", syllables: ["empieza por", "t"] },
        { word: "Tiburón", image: "tiburon.png", syllables: ["empieza por", "t"] },
    ...
    u: [
        ...
        { word: "Uña", image: "uña.png", syllables: ["empieza por", "u"] },
    ...
    v: [
        ...
        { word: "Violín", image: "violin.png", syllables: ["empieza por", "v"] }
    ],
    w: [
    ...
    x: [
        ...
        { word: "Xilófono", image: "xilofono.png", syllables: ["empieza por", "x"] }
    ],
    y: [
...
const shapes = {
    "🟢": [{ word: "Círculo", image: "circulo.png", syllables: ["empieza por", "C"] }],
    "🔺": [{ word: "Triángulo", image: "triangulo.png", syllables: ["empieza por", "T"] }],
    "🟨": [{ word: "Cuadrado", image: "cuadrado.png", syllables: ["empieza por", "C"] }],
    "🔷": [{ word: "Rombo", image: "rombo.png", syllables: ["empieza por", "R"] }],
    "❚": [{ word: "Rectángulo", image: "rectangulo.png", syllables: ["empieza por", "R"] }],
    "⬡": [{ word: "Hexágono", image: "hexagono.png", syllables: ["empieza por", "H"] }],
    "⭐": [{ word: "Estrella", image: "estrella.png", syllables: ["empieza por", "E"] }],
...
// Función mejorada para mostrar el teclado
...
// Agrega este código en la sección JavaScript

// Modificar el código de voces
let voices = [];
const voiceSelect = document.getElementById('voiceSelect');

function loadVoices() {
voices = speechSynthesis.getVoices();
voiceSelect.innerHTML = '<option value="auto">Voz automática</option>';

// Filtrar solo voces en español con alta prioridad
...
const qualityOrder = ['Google español', 'Microsoft Helena', 'Microsoft Sabina', 'Microsoft Pablo'];
...
// Si no hay voces en español, mostrar advertencia
...
currentUtterance = new SpeechSynthesisUtterance(text);
currentUtterance.rate = 0.4;  // Velocidad ligeramente más natural
currentUtterance.pitch = 1;   // Tono neutral

// Forzar siempre español aunque la voz no lo especifique
currentUtterance.lang = 'es-ES';
...
// Configuraciones adicionales para mejor pronunciación
currentUtterance.text = text
.replace(/¿/g, '')  // Remover signos de interrogación iniciales
.replace(/¡/g, '') // Remover signos de exclamación iniciales
...
// Inicialización mejorada de voces
if (speechSynthesis.onvoiceschanged !== undefined) {
speechSynthesis.onvoiceschanged = loadVoices;
}

// Cargar voces cada segundo hasta que se detecten (para móviles)
...
document.getElementById('numbersBtn').addEventListener('click', () => {
    ...
    modalTitle.textContent = 'Selecciona un número';
